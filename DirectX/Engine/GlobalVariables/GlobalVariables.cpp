...
void GlobalVariables::Update() {
	...
	for (std::map<std::string, Chunk>::iterator itChunk = datas_.begin();
		...
		for (std::map<std::string, Group>::iterator itGroup = chunk.begin();
			...
			std::map<std::string, std::map<std::string, std::map<std::string, GroupPtr>>> treeMap;
			...
			for (std::map<std::string, Item>::iterator itItem = group.begin();
				...
				size_t pos = itemName.find(kTree1Name);
			...
			for (std::map<std::string, std::map<std::string, std::map<std::string, GroupPtr>>>::iterator itTree1 = treeMap.begin();
...
void GlobalVariables::SetValue(const std::string& chunkName, const std::string& groupName, const std::string& key, int32_t value, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
...
void GlobalVariables::SetValue(const std::string& chunkName, const std::string& groupName, const std::string& key, float value, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
...
void GlobalVariables::SetValue(const std::string& chunkName, const std::string& groupName, const std::string& key, const Vector2& value, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
...
void GlobalVariables::SetValue(const std::string& chunkName, const std::string& groupName, const std::string& key, const Vector3& value, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
...
void GlobalVariables::SetValue(const std::string& chunkName, const std::string& groupName, const std::string& key, bool value, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
...
void GlobalVariables::SetValue(const std::string& chunkName, const std::string& groupName, const std::string& key, const std::string& value, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
...
void GlobalVariables::AddItem(const std::string& chunkName, const std::string& groupName, const std::string& key, int32_t value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
	std::string name;
	...
	if (tree2 == "_") {
		...
		if (tree3 == "_") {
			name = kTree1Name + tree1 + "_" + kTree2Name + tree2 + "_" + key;
			if (group.find(name) == group.end()) {
				SetValue(chunkName, groupName, key, value, tree1, tree2);
			}
		}
		else {
			name = kTree1Name + tree1 + "_" + kTree2Name + tree2 + "_" + kTree3Name + tree3 + "_" + key;
			if (group.find(name) == group.end()) {
...
void GlobalVariables::AddItem(const std::string& chunkName, const std::string& groupName, const std::string& key, float value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& chunkName, const std::string& groupName, const std::string& key, const Vector2& value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& chunkName, const std::string& groupName, const std::string& key, const Vector3& value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& chunkName, const std::string& groupName, const std::string& key, bool value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& chunkName, const std::string& groupName, const std::string& key, const std::string& value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[chunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& groupName, const std::string& key, int32_t value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[kChunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& groupName, const std::string& key, float value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[kChunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& groupName, const std::string& key, const Vector2& value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[kChunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& groupName, const std::string& key, const Vector3& value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[kChunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& groupName, const std::string& key, bool value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[kChunkName][groupName];
	std::string name;
...
void GlobalVariables::AddItem(const std::string& groupName, const std::string& key, const std::string& value, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3)
{
	Group& group = datas_[kChunkName][groupName];
	std::string name;
...
int32_t GlobalVariables::GetIntValue(const std::string& chunkName, const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(chunkName) != datas_.end());
	const Chunk& chunk = datas_.at(chunkName);
...
float GlobalVariables::GetFloatValue(const std::string& chunkName, const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(chunkName) != datas_.end());
	const Chunk& chunk = datas_.at(chunkName);
...
Vector2 GlobalVariables::GetVector2Value(const std::string& chunkName, const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(chunkName) != datas_.end());
	const Chunk& chunk = datas_.at(chunkName);
...
Vector3 GlobalVariables::GetVector3Value(const std::string& chunkName, const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(chunkName) != datas_.end());
	const Chunk& chunk = datas_.at(chunkName);
...
bool GlobalVariables::GetBoolValue(const std::string& chunkName, const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(chunkName) != datas_.end());
	const Chunk& chunk = datas_.at(chunkName);
...
std::string GlobalVariables::GetStringValue(const std::string& chunkName, const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(chunkName) != datas_.end());
	const Chunk& chunk = datas_.at(chunkName);
...
int32_t GlobalVariables::GetIntValue(const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(kChunkName) != datas_.end());
	const Chunk& chunk = datas_.at(kChunkName);
...
float GlobalVariables::GetFloatValue(const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(kChunkName) != datas_.end());
	const Chunk& chunk = datas_.at(kChunkName);
...
Vector2 GlobalVariables::GetVector2Value(const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(kChunkName) != datas_.end());
	const Chunk& chunk = datas_.at(kChunkName);
...
Vector3 GlobalVariables::GetVector3Value(const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(kChunkName) != datas_.end());
	const Chunk& chunk = datas_.at(kChunkName);
...
bool GlobalVariables::GetBoolValue(const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(kChunkName) != datas_.end());
	const Chunk& chunk = datas_.at(kChunkName);
...
std::string GlobalVariables::GetStringValue(const std::string& groupName, const std::string& key, int treeNum, const std::string& tree1, const std::string& tree2, const std::string& tree3) const
{
	assert(datas_.find(kChunkName) != datas_.end());
	const Chunk& chunk = datas_.at(kChunkName);
